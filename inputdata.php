...
if (isset($_POST['submit'])) {
    ...
    $password_sha256 = hash("sha256", $_POST['cpassword']);
    ...
    if ($password_md5 == $cpassword_md5 && $password_sha1 == $cpassword_sha1 && $password_sha256 == $cpassword_sha256) {
        $sql = "INSERT INTO user (nama, username, alamat, email, nomor, password_md5, password_sha1, password_sha256)
        VALUES ('$nama', '$username', '$alamat', '$email', '$nomor', '$password_md5', '$password_sha1', '$password_sha256')";
